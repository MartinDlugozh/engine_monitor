...
#define UART_DEF				UART_2	// UART_2 for Mega2560
...
#define TEMPERATURE_SENSOR_PIN			A0					 // номер ножки аналогового входа термистора

#define FLOW_FACTOR						0.0562f				 // коэффициент [(мл/мин)/имп] расходомера
#define THERMISTOR_BALANCE_RES			12000.0f				 // сопротивление балластного резистора в омах
#endif /* MC_CONFIG_H_ */
